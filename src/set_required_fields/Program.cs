...
if (!VersionCheck.CheckForUpdates("set_required_fields", args)) return 0;
...
{
    Console.Error.WriteLine("Usage: set_required_fields <server/profile> [-U user] [-P pass] [-O outfile] [-MSSQL|-SYBASE]");
    return 1;
}
