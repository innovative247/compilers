...
const string Usage = "Usage: set_required_fields <server/profile> [-U user] [-P pass] [-O outfile] [-MSSQL|-SYBASE]";
if (!VersionCheck.CheckForUpdates("set_required_fields", args, Usage)) return 0;
...
return InteractiveMenus.RunSetRequiredFields(cmdvars, profile, executor, headlessArgs);
