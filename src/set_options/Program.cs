...
if (!VersionCheck.CheckForUpdates("set_options", args)) return 0;
...
{
    Console.Error.WriteLine("Usage: set_options <server/profile> [-U user] [-P pass] [-O outfile] [-MSSQL|-SYBASE]");
    return 1;
}
