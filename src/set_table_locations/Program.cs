...
if (!VersionCheck.CheckForUpdates("set_table_locations", args)) return 0;
...
{
    Console.Error.WriteLine("Usage: set_table_locations <server/profile> [-U user] [-P pass] [-O outfile] [-MSSQL|-SYBASE]");
    return 1;
}
